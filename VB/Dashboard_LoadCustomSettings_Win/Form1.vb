...
Namespace Dashboard_LoadCustomSettings_Win
    Partial Public Class Form1
        ...
        Private Sub dashboardViewer1_DashboardItemControlUpdated(ByVal sender As Object,
            ...
            If e.DashboardItemName = "chartDashboardItem1" Then
                ...
                chartControl.Legend.Font = New Font(chartControl.Legend.Font.Name,
                                                    Convert.ToSingle(firstNode))
            End If
        End Sub

        Private Sub dashboardViewer1_ConfigureDataConnection(ByVal sender As Object,
            ...
            If e.ConnectionName = "nwindConnection" Then
                Dim parameters As Access97ConnectionParameters = TryCast(e.ConnectionParameters, 
