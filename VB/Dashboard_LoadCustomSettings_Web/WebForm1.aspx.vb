...
Namespace Dashboard_LoadCustomSettings_Web
    Partial Public Class WebForm1
        ...
        Protected Sub DashboardViewer_CustomJSProperties(ByVal sender As Object,
                                                         ByVal e As CustomJSPropertiesEventArgs)
            Dim element As XElement = Dashboard.LoadUserDataFromXml(
                Server.MapPath("App_Data/Dashboard.xml"))
