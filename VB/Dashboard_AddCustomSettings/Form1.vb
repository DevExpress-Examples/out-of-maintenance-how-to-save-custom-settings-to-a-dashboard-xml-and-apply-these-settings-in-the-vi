...
Namespace Dashboard_AddCustomSettings
    Partial Public Class Form1
        ...
        Public Sub New()
            ...
            Dim chartControl As ChartControl = TryCast(DirectCast(dashboardDesigner1, 
                    IUnderlyingControlProvider).GetUnderlyingControl("chartDashboardItem1"), 
                ChartControl)
            barEditItem1.EditValue = chartControl.Legend.Font.Size
        End Sub

        Private Sub barEditItem1_EditValueChanged(ByVal sender As Object, ByVal e As EventArgs) _
        ...
        Private Sub dashboardDesigner1_DashboardClosing(ByVal sender As Object,
            ...
            If dashboardChanged Then
                ...
                e.Dashboard.UserData = New System.Xml.Linq.XElement("chartFontSize",
        ...
        Private Sub SaveDashboards()
            Dim path As String = Directory.GetParent(Application.ExecutablePath).
                Parent.Parent.Parent.FullName
            dashboardDesigner1.Dashboard.SaveToXml(
                path & "\Dashboard_LoadCustomSettings_Win\Data\Dashboard.xml")
            dashboardDesigner1.Dashboard.SaveToXml(
                path & "\Dashboard_LoadCustomSettings_Web\App_Data\Dashboard.xml")
            dashboardDesigner1.Dashboard.SaveToXml(
                path & "\Dashboard_LoadCustomSettings_Mvc\App_Data\Dashboard.xml")
